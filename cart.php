  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">CARRINHO</span> 
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<input class="btn btn-primary" type="submit" name="apply_coupon" value="Aplicar código do Cupom" >
...
Fazer o check-out <i class="fa fa-chevron-right"></i>
