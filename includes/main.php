...
<?php
if(!isset($_SESSION['customer_email'])){
  echo '<a href="login.php" class="login__link">Entrar</a>';
} 
  else
  { 
              ...
              <div class="dropdown dropdown--lookbook">
                <div class="clearfix">
                  ...
                  <div class="dropdown__half">
                    ...
                    <ul class="dropdown__items">
                      <li class="dropdown__item">
                        <a href="#" class="dropdown__link">Editar Perfil</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="#" class="dropdown__link">Alterar Senha</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="#" class="dropdown__link">Deletar Perfil</a>
                      </li>
                    </ul>
                  </div>
                </div>
